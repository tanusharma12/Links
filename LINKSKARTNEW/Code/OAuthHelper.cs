...
public class OAuthHelper
{
    ...
    static string oauth_consumer_key = "xZEV2y8Tlvu4RbZWuVtsFhGJO";
    static string oauth_consumer_secret = "kokijgTSJnKmOLtEMlvZJtZMl0Dd0vFxqmK4kmIf1oVxFWgF9r";
    static string callbackUrl = "http://linkskart.com/frm_login.aspx";
